...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
 ...
 State constant defaultState = State.Harvested;
  ...
  modifier verifyCaller (address _address) {
    require(msg.sender == _address, "Verify the Caller");
    _;
  }
...
items[_upc] = Item({
            ...
            productPrice: uint(0), // should I set these to 0?
            itemState: defaultState, // should I set these to 0?
            distributorID: address(0), // should I set these to 0?
            retailerID: address(0), // should I set these to 0?
            consumerID: address(0) // should I set these to 0?
});
    // Increment sku
    sku = sku + 1;
